...
# Нахождение медианы через удаление максимальных элементов
...
print(f'test_3 (lsort list) {timeit.timeit("gnome_median(TO_SORT)", globals=globals(), number=100)} milliseconds')
